...
class MultiScaleMaskedTransformerDecoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.ref_anchor_head = MLP(hidden_dim, hidden_dim, 2, 2)
    ...
    def forward(self, x, mask_features, mask = None):
        ...
        #     # output = torch.zeros(num_queries, bs, self.d_model, device=refpoint_embed.device)
        # else:
        #     output = self.patterns.weight[:, None, None, :].repeat(1, self.num_queries, bs, 1).flatten(0, 1) # n_q*n_pat, bs, d_model
        ...
        for i in range(self.num_layers):
            ...
            output = self.transformer_cross_attention_layers[i](
                ...
                pos=pos[level_index], query_pos=query_sine_embed
            )
